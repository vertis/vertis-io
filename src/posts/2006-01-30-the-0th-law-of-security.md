...
Even without further explanation (which is available [here](http://www.microsoft.com/technet/columns/security/10imlaws.asp)) it is a fairly straight forward and common sense list of laws.
