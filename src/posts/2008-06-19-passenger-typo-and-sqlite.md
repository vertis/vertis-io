...
I upgraded my rails sites to use [Passenger aka Mod Rails](http://www.modrails.org) this week. I'd like to say its been all roses, but the truth is that my Typo blog would swear under oath that its not the case. I was quite happy with the out of box Typo + Sqlite combination, and that worked fine under mongrel. Not so under passenger, the website will work perfectly, but I won't be able to get into the admin section. As you can see I managed to get it working, I switched the database to mysql and its been working fine ever since. I'll get around to working out WHY it doesn't work with sqlite at some point (and get around to extracting my lost blog posts).
