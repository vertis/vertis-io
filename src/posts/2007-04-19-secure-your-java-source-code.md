...
Obfuscating the source code is one method that is often used to protect Java code. It refers to deliberately making the code harder to read. Rather than a cracker getting back a function called _IDoSomethingCool (String name)_ ... they instead might get something back like _dadaba3 (String adabc9989)._
