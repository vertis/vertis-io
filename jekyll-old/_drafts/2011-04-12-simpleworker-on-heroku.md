...
have the _zero-config_ joy of Heroku can support multiple delayed_job workers, has other overheads, like the need to monitor the
workers.

This has caused me to move at least one of my apps away from Heroku to a VM. While a VM may not have the _zero-config_ joy of Heroku it
